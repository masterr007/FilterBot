...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5941372397:AAFvb1yV-yagcjLp9ROQRbBcXr_YxZX4CIQ")
    ...
    DATABASE_URI = os.environ.get("DATABASE_URI", "mongodb+srv://nano:nano@cluster0.3045qne.mongodb.net/?retryWrites=true&w=majority")
